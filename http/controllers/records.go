...
func (ctrl *RecordController) Map(router *context.App) {
	router.Get("/api/apps/:app/records/:collection/data", ctrl.auth(true), ctrl.list)
	router.Get("/api/apps/:app/records/:collection/data/:record", ctrl.auth(true), ctrl.get)
	router.Post("/api/apps/:app/records/:collection/data", ctrl.auth(true), ctrl.create)
	router.Put("/api/apps/:app/records/:collection/data/:record", ctrl.auth(true), ctrl.update)
	router.Delete("/api/apps/:app/records/:collection/data/:record", ctrl.auth(true), ctrl.delete)
}
